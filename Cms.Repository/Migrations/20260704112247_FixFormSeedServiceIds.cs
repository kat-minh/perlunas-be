...
{
    /// <inheritdoc />
    public partial class FixFormSeedServiceIds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Standard Tour Room" }, new Guid("04d243a2-c184-4e32-6ebd-bf055b3d82f3") });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Deluxe Room" }, new Guid("e50a45c4-40d6-316f-0e40-2e58860b0f8e") });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Heritage Suite" }, new Guid("6fc490b0-6501-7066-2716-f195529f23d3") });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Superior Tour Room" }, new Guid("04d243a2-c184-4e32-6ebd-bf055b3d82f3") });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Eco Lodge Room" }, new Guid("1c319bb9-c82d-5a4a-22b3-2f5d6625fbd2") });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Royal Suite" }, new Guid("8e401cad-0a9e-259e-9819-bf4842528f05") });

            migrationBuilder.UpdateData(
                table: "Forms",
                keyColumn: "Id",
                keyValue: new Guid("99999999-9999-9999-9999-999999999991"),
                columns: new[] { "ServiceId", "Title" },
                values: new object[] { new Guid("04d243a2-c184-4e32-6ebd-bf055b3d82f3"), "Tour Đà Nẵng" });

            migrationBuilder.UpdateData(
                table: "Forms",
                keyColumn: "Id",
                keyValue: new Guid("99999999-9999-9999-9999-999999999992"),
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { "Miền Trung", new Guid("e50a45c4-40d6-316f-0e40-2e58860b0f8e"), "Đặt phòng Đà Nẵng" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { "Miền Trung", new Guid("6fc490b0-6501-7066-2716-f195529f23d3"), "Combo Đà Nẵng" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { "Miền Bắc", new Guid("1c319bb9-c82d-5a4a-22b3-2f5d6625fbd2"), "Đặt phòng Sa Pa" });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { "Miền Bắc", new Guid("8e401cad-0a9e-259e-9819-bf4842528f05"), "Đặt phòng Hà Nội" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Standard Tour Room" }, new Guid("11111111-1111-1111-1111-111111111111") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa2"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Deluxe Room" }, new Guid("11111111-1111-1111-1111-111111111112") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Heritage Suite" }, new Guid("11111111-1111-1111-1111-111111111113") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa4"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Superior Tour Room" }, new Guid("11111111-1111-1111-1111-111111111111") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Eco Lodge Room" }, new Guid("11111111-1111-1111-1111-222222222211") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6"),
                columns: new[] { "RoomCategory", "ServiceId" },
                values: new object[] { new List<string> { "Royal Suite" }, new Guid("11111111-1111-1111-1111-222222222212") });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("99999999-9999-9999-9999-999999999992"),
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { null, new Guid("11111111-1111-1111-1111-111111111112"), null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("99999999-9999-9999-9999-999999999993"),
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { null, new Guid("11111111-1111-1111-1111-111111111113"), null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("99999999-9999-9999-9999-999999999995"),
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { null, new Guid("11111111-1111-1111-1111-222222222211"), null });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("99999999-9999-9999-9999-999999999996"),
                columns: new[] { "Region", "ServiceId", "Title" },
                values: new object[] { null, new Guid("11111111-1111-1111-1111-222222222212"), null });
