...
{
    /// <inheritdoc />
    public partial class CorrectFormAndFormDetailsSeeds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "FormId", "RoomCategory" },
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999995"), new List<string> { "Eco Lodge Room" } });
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "FormId", "RoomCategory" },
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999996"), new List<string> { "Royal Suite" } });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                columns: new[] { "FormId", "RoomCategory" },
                values: new object[] { new Guid("11111111-1111-1111-1111-222222222211"), new List<string> { "Eco Lodge Room" } });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa6"),
                columns: new[] { "FormId", "RoomCategory" },
                values: new object[] { new Guid("11111111-1111-1111-1111-222222222212"), new List<string> { "Royal Suite" } });
