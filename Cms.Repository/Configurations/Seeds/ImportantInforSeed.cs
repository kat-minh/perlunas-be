...
public static class ImportantInforSeed
{
    public static void SeedImportantInfor(this EntityTypeBuilder<ImportantInfor> builder)
    {
        builder.HasData(
            ...
            new ImportantInfor { Id = SeedIds.ImportantResort, ServiceId = SeedIds.ServicePrivate, Title = "Resort check-in", SubTitle = "Required documents", Description = "Guests must present valid identification at check-in.", CreatedAt = SeedIds.CreatedAt, UpdatedAt = SeedIds.CreatedAt },
