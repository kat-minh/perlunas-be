...
public class UpdateDepartureScheduleRequestValidator : AbstractValidator<Request.UpdateDepartureScheduleRequest>
{
    public UpdateDepartureScheduleRequestValidator()
    {
