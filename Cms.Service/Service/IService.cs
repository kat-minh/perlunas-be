...
public interface IService
{
    ...
    Task<BasePaginationResponse> GetToursAsync(string? keyword, string? destination, string? city, bool? bestSeller, int pageIndex, int pageSize);
    ...
    Task<BasePaginationResponse> GetHotelsAsync(string? keyword, string? destination, string? form, string? purposeOfTrip, bool? bestSeller, int pageIndex, int pageSize);
