...
public class CreateUserRequestValidator : AbstractValidator<Request.CreateUserRequest>
{
    public CreateUserRequestValidator()
    {
        ...
        RuleFor(x => x.Password).NotEmpty().WithMessage("PASSWORD_REQUIRED").MinimumLength(6).WithMessage("PASSWORD_MIN_LENGTH").MaximumLength(256).WithMessage("PASSWORD_MAX_LENGTH");
